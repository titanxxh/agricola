...
test('valid fencing, 1 grid 1 pasture', () => {
  const a = new farmBoard();
...
test('valid fencing, 9 grid 1 pasture', () => {
  const a = new farmBoard();
...
test('valid fencing, 9 grid 2 pasture', () => {
  const a = new farmBoard();
...
test('valid fencing, 6 grid 4 pasture', () => {
  const a = new farmBoard();
...
test('invalid fencing, no pasture', () => {
  const a = new farmBoard();
  const fence = [1, 11, 13];
  fence.forEach(v => {
    a.buildFence(v);
...
test('invalid fencing, 1 fence out of 1 pasture', () => {
  const a = new farmBoard();
...
test('invalid fencing, 1 fence inside 1 pasture', () => {
  const a = new farmBoard();
